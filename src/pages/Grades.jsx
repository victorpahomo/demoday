            ...
            (
              <>
                <section className="mb-5 items-center">
                  <h1 className="text-base text-start text-primary-Azul5 font-medium w-1/4">Tu progreso general :</h1>
                  <StepProgress step={2} />
                </section>
                <div id="descriptionGrades" className="mb-5 text-primary-Azul5 font-medium">
                  <p>
                    {" "}
